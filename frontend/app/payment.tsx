...
const [paymentMessage, setPaymentMessage] = useState("");
  ...
  const [showDayEndConfirm, setShowDayEndConfirm] = useState(false);
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <View style={{ flexDirection: "row", gap: 8 }}>
            ...
            {canAccessDayEnd && canAccessDayEnd() && (
              <TouchableOpacity
                style={[
                  styles.backBtn,
  ...
  <View style={[
    ...
    <Text style={[
      ...
      <Modal
        ...
        transparent={true}
        animationType="fade"
        onRequestClose={() => setShowDayEndConfirm(false)}
      >
        <TouchableOpacity 
          style={{
            flex: 1,
          ...
          activeOpacity={1}
          onPress={() => setShowDayEndConfirm(false)}
        >
          <TouchableWithoutFeedback>
            <View 
              style={{
              ...
              <View style={{ flexDirection: "row", gap: 12, width: "100%" }}>
                ...
                <TouchableOpacity
                  style={{
                    ...
                    justifyContent: "center",
                    alignItems: "center",
                    opacity: isDayEnding ? 0.7 : 1
                  }}
                  disabled={isDayEnding}
                  onPress={() => {
