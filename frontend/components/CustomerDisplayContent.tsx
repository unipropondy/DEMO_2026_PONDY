 ...
 *
 * Pure lift-and-shift of CustomerDisplayScreen from app/customer-display.tsx.
 * All business logic, socket listeners, Zustand stores, animations, QR code
 * rendering, and layout are preserved exactly as-is.
 *
 * The Back button and terminal pill are intentionally kept for the QA/testing
 * phase so that developers can exit the customer display and validate dual-
 * display behaviour during development on a real Sunmi D3.
 *
 * Path difference vs original: this file lives in components/ (same depth from
 * the project root as app/), so all "../constants/*" and "../stores/*" relative
 * import paths are identical — no import changes required.
 *
 * NOTE: The default export is named CustomerDisplayContent to distinguish it
 * from the route-level CustomerDisplayScreen wrapper in app/customer-display.tsx.
 * app/customer-display.tsx re-exports this component as its default export so
 * the /customer-display route continues to work unchanged for staff navigation.
 */
